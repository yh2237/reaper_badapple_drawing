local frameDataDir = "./collar-frames_data" -- フレームデータのディレクトリのパス
local frameHeight = 25 -- 縦サイズ（collar-index.jsのサイズと同じにする）
local sizeX = 33 -- 横サイズ（collar-index.jsのサイズと同じにする）
